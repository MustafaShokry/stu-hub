  ...
  return (
    <>
      <header class="w-[100%] absolute right-0 top-0">
        <nav class="bg-gray-800 shadow-lg border-gray-200 py-2.5">
          <div class="flex flex-wrap items-center justify-between px-8 mx-auto">
            <Link href="/" class="flex items-center">
              <Image src={logo} class=" h-12 w-12 mr-3" alt="Landwind Logo" />
      ...
      <section className=" relative left-[11%]">
          ...
          <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            <div
              ...
              <div className="flex justify-center">
                <Link
                  href="/aboutus"
                  className="inline-flex text-white bg-[#11ab9e] border-0 py-2 px-6 focus:outline-none rounded text-lg">
                  About us
                </Link>
                <Link
                  href="learnmore"
              ...
              <div className="p-4 md:w-1/3">
                <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                  ...
                  <div className="flex-grow">
                    ...
                    <a className="mt-3 text-[#11ab9e] inline-flex items-center">
                      Learn More
                      <svg
                        fill="none"
                        stroke="currentColor"
          ...
          <div className="container px-5 py-24 mx-auto flex flex-wrap">
            ...
            <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
              <div className="flex flex-col mb-10 lg:items-start items-center">
                <div className="w-12 h-12 inline-flex items-center justify-center rounded-full bg-indigo-100 text-[#11ab9e] mb-5">
                  <svg
                    fill="none"
                    stroke="currentColor"
                    strokeLinecap="round"
        ...
        <section
          ...
          <div className="container px-5 py-24 mx-auto">
            ...
            <div className="flex flex-wrap -m-4">
              <div className="xl:w-1/3 md:w-1/2 p-4">
                <div className="border border-gray-300 p-6 rounded-lg">
                  <div className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-[#11ab9e] mb-4">
                    <svg
                      fill="none"
                      stroke="currentColor"
                      strokeLinecap="round"
            ...
            <button className="flex mx-auto mt-16 text-white bg-[#11ab9e] border-0 py-2 px-8 focus:outline-nonerounded text-lg">
              Leanr More
            </button>
          </div>
        </section>
          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
              ...
              <p className="leading-relaxed text-lg">
                ...
                gentrify plaid gastropub normcore XOXO 90s pickled cindigo jean
